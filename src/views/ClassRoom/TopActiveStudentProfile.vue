        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
            <div class="profile-image">
              <img v-if="profile_pic" :src="profile_pic" class="rounded-circle" />
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <div class="sideNav">
            <button class="btn btn-warnings active shadow-none" style="width: 100%" id="step1" @click="div1()">
              Feed
            </button>
            <button class="btn btn-warnings mt-4 shadow-none" style="width: 100%" id="step2" @click="div2()">
              My Course
            </button>
            <button class="btn btn-warnings mt-4 shadow-none" style="width: 100%" id="step3" @click="div3()">
              Friends
            </button>
            <button v-if="user_type == 2" class="btn btn-warnings mt-4 shadow-none" style="width: 100%" id="step4"
              @click="div4()">
              Office Hours
            </button>
            <button class="btn btn-warnings mt-4 shadow-none" style="width: 100%" id="step5" @click="div5()">
              Gallery
            </button>
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          <div class="custom-card p-3" v-if="one">
            ...
            <div class="card mt-4" style="background: #f9f9f9" v-for="item in PostsData" :key="item.id">
              <div class="container-fluid">
                ...
                <div class="card-header" style="background: #f9f9f9">
                  <div class="row">
                    <div class="col-3">
                      <img v-if="item.postedBy.profile_pic" :src="item.postedBy.profile_pic" class="rounded-circle"
                        style="width: 100%" />

                      <img v-else src="../../assets/main/user.png" class="rounded-circle" style="width: 100%" />
                    </div>
                    ...
                    <div class="col-9">
                      <div class="post-information mt-1">
                        ...
                        <h6>
                          ...
                          <span style="color: #0776bd"><span v-if="item.postedBy.user_type == 1">
                ...
                <div class="card-body">
                  ...
                  <div class="post-media">
                    <div class="entry">
                      <div v-if="item.image">
                        <img :src="url + item.image" class="img-fluid" alt="Responsive image" />
                        <div class="magnifier">
                          <div class="magni-desc">
                            <a class="secondicon example-image-link" data-lightbox="example-set">
                              <span class="fa fa-search-plus" data-glyph="zoom-in" title="Read More" aria-hidden="false"
                                id="search-plus" @click="getImgUrl(item.image)"></span></a>
                          </div>
                        </div>
                      </div>
                      <div class="home-pic-card px-2 text-center" v-if="item.file">
                        <span><a v-bind:href="url + item.file" target="blank"
                            style="color: #0776bd; text-decoration: none"><b> Download File </b></a>
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex post-condition mt-3">
                    ...
                    <p class="p-1">
                      <span style="color: #f75555" true-value="1" false-value="0">{{ item.is_false }}
                      </span>
                      FALSE
                    </p>
                    <p class="p-1">
                ...
                <div class="card-footer" style="background: #f9f9f9">
                  <div class="d-flex mt-2 mb-2" style="float: left">
                    <i class="fa fa-check true" @click="trueValue(item.id)" id="green"></i>
                    <i class="fa fa-times false" @click="falseValue(item.id)" id="red"></i>
                    <i class="fa fa-lightbulb bulb" @click="highValue(item.id)" id="yellow"></i>
                  </div>

                  <div class="d-flex mb-2 mt-2" style="float: right">
                    <span class="last">
                      <img src="../../assets/main/restore.png" @click="comments(item.id)" style="cursor: pointer" />
                ...
                <div v-if="reply">
                  <form @submit.prevent="commentSubmit(item.id)">
                    <div class="mt-5 mb-2" style="background-color: white; border: 2px solid white">
                      <div class="row p-2 mt-2">
                        <div class="col-2">
                          <img src="../../assets/main/user.png" class="rounded-circle" style="width: 100%" />
                        </div>
                        <div class="col-8">
                          <input type="text" class="form-control shadow-none"
                            placeholder="Share Your Lectures,exams,notes etc" v-model="commentForm.description" />
                        </div>
                  ...
                  <div class="p-2">
                    <div class="row p-2 mt-2" style="background-color: white; border: 1px solid #f9f9f9"
                      v-for="reply in item.post_replies" :key="reply.id">
                      <div class="col-2">
                        <img src="../../assets/main/user.png" class="rounded-circle m-1" style="width: 100%" />
                      </div>
                      ...
                      <div class="col-10">
                        ...
                        <div class="d-flex post-condition">
                          ...
                          <p class="p-1">
                            <span style="color: #f75555" true-value="1" false-value="0">{{ reply.is_false }}
                            </span>
                            FALSE
                          </p>
                          <p class="p-1">
                      ...
                      <div class="col-10 post-information mt-1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-8 col-lg-9" align="right">
                            <span class="last">
                              <img src="../../assets/main/restore.png" style="cursor: pointer" />
                              Reply {{ item.post_replies.length }}
                            </span>
                          </div>
                        </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mt-3" v-for="item in courseDetail" :key="item.id">
                    <div class="card">
                      <div class="card-body course">
                        ...
                        <button class="btn mt-2" v-if="item.is_active == 1" @click="Active(item.id)" id="green">
                          Active
                        </button>
                        <button class="btn red mt-2" v-if="item.is_active == 0" @click="notActive(item.id)" id="red">
                          Not-Active
                        </button>
                      </div>
                      <div class="card-footer course-footer">
                        <div class="row mb-2">
                          <div class="col-12">
                            <div class="d-flex course-image" @click="viewPage(item.intructor.user_id)">
                              <div class="col-2">
                                <img :src="studentImage" class="rounded-circle" style="width: 100%" />
                              </div>
                              <div class="col-10">
          ...
          <div class="custom-card p-3" v-if="three">
            <div class="row">
              ...
              <div class="col-6" align="right">
                <span style="color: #0776bd">
                  Search For Others
                  <img src="../../assets/classroom/record.png" style="width: 10%" />
                </span>
              </div>
            </div>
            ...
            <div class="card" style="border-color: transparent">
              <div class="card-body">
                <div class="row">
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-2">
                    <button class="btn nav-link actives" id="Friend1" @click="First()">
                      All Friends
                    </button>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 mt-2">
              ...
              <div class="card" v-if="Friends" style="border-color: transparent">
                <div class="card-body">1</div>
              </div>

              <div class="card" v-if="Collegaues" style="border-color: transparent">
                <div class="card-body">
                  <div class="Following-data mt-3" v-for="item in followingItems" :key="item.id">
                    <div class="row p-3">
                      <div class="col-6">
                        <div class="row">
                          <div class="col-4">
                            <img :src="item.img" class="rounded-circle" style="width: 100%" />
                          </div>
                          <div class="col-8 mt-lg-4">
                            <span style="color: #0776bd">-{{ item.universityName }}
                            </span>
              ...
              <div class="card" v-if="Following" style="border-color: transparent">
                <div class="card-body">
                  <div class="Following-data mt-3" v-for="item in followingItems" :key="item.id">
                    <div class="row p-3">
                      <div class="col-6">
              ...
              <div class="card" v-if="Followers" style="border-color: transparent">
                <div class="card-body">
                  <div class="Following-data mt-3" v-for="item in followingItems" :key="item.id">
                    <div class="row p-3">
                      <div class="col-6">
            ...
            <div class="card mt-2" style="border: none">
              <div class="row">
                <div class="col-sm-12 col-xs-12 col-md-4 col-lg-4 mt-3">
                  <img src="../../assets/main/post.png" class="img-fluid" style="width: 100" />
                </div>
...
export default {
  ...
  beforeCreate() {
    ...
    ContentDataService.getStudentById(this.user_id).then(
      (response) => {
        console.log(response.data.data);
        this.profilePicture = response.data.data.profile_pic;
        this.studentName = response.data.data.first_name;
        this.universityName = response.data.data.university.name;
        this.type = response.data.data.degree.name;
  ...
  methods: {
    getPost() {
      ContentDataService.getInstituteFeedId(this.id).then((response) => {
        this.post = response.data.data;
      });
    },

    getFollowers() {
      ContentDataService.getFollowers(this.id).then((response) => {
    ...
    getFriends() {
      ContentDataService.getFriends(this.id).then((response) => {
        this.friends = response.data.data;
      });
    },
    getPoint() {
      ContentDataService.getPointsOne(this.id).then((response) => {
        console.log(response.data.data);
    ...
    getMyAllPosts() {
      ContentDataService.getMyPostsOne(this.id).then((response) => {
        console.log(response.data.data)
