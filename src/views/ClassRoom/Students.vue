            ...
            <div class="card-body">
              ...
              <div class="filters">
                ...
                <select class="form-select shadow-none mt-2">
                  <option>All Post Type</option>
                  <option>POSTS1</option>
                  <option>POSTS 2</option>
                </select>

                <select class="form-select shadow-none mt-2">
                  <option>All Institutes</option>
                  <option>Institues Names</option>
                  <option>Institutes Name</option>
                </select>
